...
{
    public List<IngameServerProgram> List { get; init; }
    public IngameConsoleCommandList()
    {
        List = new();
        List.Add(new IngameServerProgram(IngameServerProgramTypes.ResearchProgram, 1f, 2));
        List.Add(new IngameServerProgram(IngameServerProgramTypes.SignalSciDataProcessing, 1f, 2));
        List.Add(new IngameServerProgram(IngameServerProgramTypes.AI, 0f, 1));                    //WIP
        List.Add(new IngameServerProgram(IngameServerProgramTypes.CrewMonitor, 0f, 1));           //WIP
        List.Add(new IngameServerProgram(IngameServerProgramTypes.Cameras, 0f, 1));               //WIP
        List.Add(new IngameServerProgram(IngameServerProgramTypes.Telecommunication, 0f, 1));     //WIP
    }
}