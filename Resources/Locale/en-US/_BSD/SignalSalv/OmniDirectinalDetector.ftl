...
ODD_Tier3_Hint = -> The detector one located at ({$W1},{$X1},{$Y1},{$Z1}) has detected the bluespace signal towards ({$W1D},{$X1D},{$Y1D},{$Z1D})\n-> The detector two located at ({$W2},{$X2},{$Y2},{$Z2}) has detected the bluespace signal towards ({$W2D},{$X2D},{$Y2D},{$Z2D})